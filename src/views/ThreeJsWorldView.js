...
export default class ThreeJsWorldView {
        ...
        this.updateShapeView = (function (scene) {
            ...
            var getEntityMaterial = function (entity) {
                if (entity) {
                    ...
                    } else if (entity instanceof Ninja) {
    ...
    resize(reduce) {
        reduce = reduce || 2.5;
        const width = global.width / reduce;
        const height = global.height / reduce;
        ...
        if (renderer.domElement.getContext('2d')) {
            renderer.domElement.getContext('2d').scale(pixelRatio, pixelRatio);
        }
