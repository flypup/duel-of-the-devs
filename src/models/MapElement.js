...
export default class MapElement {
    ...
    constructor(element) {
        ...
        global.copy(this, element);
        this.init();
        this.assignShapes();

        if (global.debug > 1 && this.constructor === MapElement) {
            Object.seal(this);
        }
    }
    ...
    loadImages(path) {
        if (this.image || this.fillImage) {
            this.imageData = Images.getImage(path + '/' + (this.image || this.fillImage));
        }
        if (this.fillColor) {
    ...
    addCircle(v1, r, mapShape) { // TODO: Oval
    ...
    addPolygons(v1, verts, body, offset, mapShape) {
    ...
    addConvexHull(v1, verts, body, offset, mapShape) {
...
global.entities.MapElement = MapElement;
